...
const Travel = () => {
  return (
    <>
      <section className="flex flex-col md:flex-row items-center justify-between w-11/12 md:-mb-40 lg:-mb-60 sm:-mt-10 mx-auto mt-8 bg-white p-5 rounded-lg min-h-[80vh] gap-x-8"> 
