...
const Footer = () => {
  return (
    <footer className="relative bg-white border-t border-gray-300 px-4 py-8 md:px-8 md:pt-40"> {/* Adjusted padding top */}
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="text-center md:text-left mb-6 md:mb-0 md:w-1/4"> {/* Adjusted width for desktop layout */}
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="text-gray-600 hover:text-black">Book Demo</a></li>
          </ul>
        </div>
