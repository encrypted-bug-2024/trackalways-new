const WhyUs = () => {
  ...
  <div className="absolute top-[-60px] right-[-80px] w-48 h-48 border-dotted border-2 border-green-500 rounded-full"
       style={{ borderTopColor: 'transparent', borderRightColor: 'transparent' }}></div>
  <div className="absolute  bottom-[-80px] left-[-80px] w-48 h-48 border-dotted border-2 border-green-500 rounded-full"
       style={{ borderBottomColor: 'transparent', borderLeftColor: 'transparent' }}></div>

  <h2 className="text-4xl text-center mb-10">Why Choose Us?</h2>

  <div className="flex flex-col md:flex-row justify-center gap-8">
    {/* Card 1 */}
    <div className="bg-white p-8 md:p-16 rounded-lg shadow-lg w-full h-auto md:w-1/3 text-center flex flex-col justify-between">
